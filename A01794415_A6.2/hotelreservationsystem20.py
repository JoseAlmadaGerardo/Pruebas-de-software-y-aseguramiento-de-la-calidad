...
class HotelManager:
    ...
    def run(self):
        ...
        while True:
            ...
            print("2. Display all Hotels information")
            print("3. Modify Hotel Information")
            ...
            if choice == '1':
                ...
                if hotel_name.lower() in self.database.hotels:
                    ...
                    print("1. Hotel Name", "2. Location", "3. Phone")
...
class CustomerManager:
    def __init__(self):
        """
        Init customer data base.
        """
        self.database = CustomerDatabase()

    def run(self):
        """
        Run customer info menu.
        """
        while True:
            print("-----------------------------------------")
...
class ReservationManager:
    def __init__(self):
        ...
        self.available_rooms = {
            'std': [101, 102, 103], 'delux': [201, 202, 203],
            'suite': [301, 302, 303]}
    ...
    def run(self):
        """
        Run reservation management menu.
        """
        while True:
            print("-----------------------------------------")
    ...
    def check_in(self, name, address, phone):
        """
        Check in a customer from a room.
        """
        ...
        if roomtype in [1, 2, 3]:
            if self.available_rooms['std'] and roomtype == 1:
                ...
                return
            try:
                d, m, y = map(int, input("Check-in date: dd mm yyyy").split())
                check_in_date = date(y, m, d)
            except ValueError:
                print("Invalid date format. Format required: dd mm yyyy.")
                return
            self.rooms[room_no] = {'name': name, 'phone': phone,
                                   'check_in_date': check_in_date,
                                   'room_type': roomtype}
            print(f'Checked in {name}, phone: {phone}')
            print(f'to room: {room_no} on {check_in_date}')
            self.database.save_data()
        else:
    ...
    def check_out(self, room_number):
        ...
        if room_number in self.rooms:
            ...
            if roomtype in [1, 2, 3]:
                ...
                print(f'Number of Days: {duration}')
                print(f'tPrice per day: ${self.roomprice[roomtype]}')
...
class HotelDatabase:
    ...
    def save_data(self):
        ...
        """
        hoteldata = {'hotels': [hotel.__dict__
        ...
        try:
            with open(self.file_name, 'r', encoding='utf-8') as file:
                ...
                if 'hotels' in hoteldata:
                    self.hotels = {
                        hotel['name'].lower(): Hotel(hotel['name'],
                                     hotel['location'], hotel['phone'])
    ...
    def display_all_hotels_info(self):
        ...
        if self.hotels:
            ...
            for hotel in self.hotels.items():
                print("-----------------------------------------")
                hotel.display_info()
        else:
...
class CustomerDatabase:
    ...
    def save_data(self):
        ...
        customersdata = {'customers':
          [customer.__dict__ for customer in self.customers.values()]}
        with open(self.file_name, 'w', encoding='utf-8') as file:
        ...
        try:
            with open(self.file_name, 'r', encoding='utf-8') as file:
                ...
                if 'customers' in customersdata:
                    self.customers = {
                        customer['name'].lower(): Customer(customer['name'],
...
class ReservationDatabase:
    ...
    def save_data(self):
        ...
        """
        Reservationdata = {
            'reservations': [reservation.__dict__
            ...
            with open(self.file_name, 'r', encoding='utf-8') as file:
                ...
                if 'reservations' in Reservationdata:
                    self.reservations = [Reservation(**reservation)
                            for reservation in Reservationdata['reservations']]
                else:
                    self.reservations = []
        except FileNotFoundError:
            pass
